  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <polygon
        ...
        fill="#1a3a7a" stroke="#60a5fa" strokeWidth="2" strokeLinejoin="round"
      />
      ...
      <path d="M 58 25 Q 72 18 80 10" fill="none" stroke="#6a420e" strokeWidth="4" strokeLinecap="round" />
      <path d="M 58 25 Q 72 18 80 10" fill="none" stroke="#c9a43a" strokeWidth="2.5" strokeLinecap="round" />
