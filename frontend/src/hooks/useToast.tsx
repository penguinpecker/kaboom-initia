...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  const colorMap: Record<string, string> = {
    primary: "border-primary/20", emerald: "border-emerald/20",
    amber: "border-amber/20",     error: "border-error/20",
    secondary: "border-secondary/20",
  };
  const dotMap: Record<string, string> = {
    primary: "bg-primary", emerald: "bg-emerald", amber: "bg-amber",
    error: "bg-error", secondary: "bg-secondary",
  };
